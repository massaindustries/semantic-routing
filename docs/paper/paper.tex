...
\begin{itemize}\setlength{\itemsep}{3pt}
  ...
  \item \textbf{Bayesian prior pseudo-count} $k{=}8$ in the skill-matrix smoothing: chosen so that the prior dominates only for skill-matrix cells with fewer than ${\sim}10\%$ of the median per-cell support, leaving high-coverage cells dominated by empirical evidence.
